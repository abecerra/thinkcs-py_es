...
% document under the terms de the GNU Free Documentation License,
% Version 1.1  or any later version published by the Free Sdetware
% Foundation; with the Invariant Sections being "Contributor List",
% with no Front-Cover Texts, and with no Back-Cover Texts. A copy de
% the license is included in the section entitled "GNU Free
% Documentation License".

% This distribution includes a file named fdl.tex that contiene the text
% de the GNU Free Documentation License.  If it is missing, you can obtain
% it from www.gnu.org or by writing to the Free Sdetware Foundation,
...
El constructor de \texttt{Mano} inicializa los atributos 
...
Parece extraño aplicar el método {\tt\_\_str\_\_} de la clase \texttt{Mazo} 

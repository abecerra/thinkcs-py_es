...
\end{lstlisting}
\inputencoding{utf8}El denominador es opcional. Una Fracción con un solo parámetro representa
...
\end{lstlisting}
\inputencoding{utf8} Para realizar pruebas, ponemos este código en un archivo \texttt{Fraccion.py}
...
La fraccion es 5/6
\end{lstlisting}
\inputencoding{utf8} El método \texttt{print}, automáticamente invoca al método \texttt{\_\_str\_\_}
de manera implícita.
...
\end{lstlisting}
\inputencoding{utf8}
Podemos probar este método calculando un producto sencillo:\inputencoding{latin9}
\begin{lstlisting}
...
y convertirlo a una fracción antes de realizar el producto:\inputencoding{latin9}
\begin{lstlisting}
class Fraccion:
  ...
  def __mul__(self, otro):
...
\end{lstlisting}
\inputencoding{utf8} Para evaluar un operador binario como la multiplicación, Python chequea
...
class Fraccion:
  ...
  __rmul__ = __mul__
\end{lstlisting}
\inputencoding{utf8} Esta asignación dice que \texttt{\_\_rmul\_\_} contiene el mismo
...
20/6
\end{lstlisting}
\inputencoding{utf8} Como \texttt{\_\_rmul\_\_} tiene el mismo código que \texttt{\_\_mul\_\_},
...
class Fraccion:
  ...
  __radd__ = __add__
\end{lstlisting}
\inputencoding{utf8} Podemos probar estos métodos con objetos \texttt{Fraccion} y con
números enteros.
...
17/6
\end{lstlisting}
\inputencoding{utf8} Los primeros ejemplos llaman al método \texttt{\_\_add\_\_}; el último
...
def MDC (m, n):
  if m % n == 0:
    ...
    return MDC(n, m%n)
\end{lstlisting}
\inputencoding{utf8} En la primera línea el operador residuo nos permite chequear si n
...
-25/9
\end{lstlisting}
\inputencoding{utf8} Una característica adicional que nos provee \texttt{MDC} es que si

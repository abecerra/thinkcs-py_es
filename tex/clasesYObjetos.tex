...
Una definición de clase se parece a esto:\inputencoding{latin9}
\begin{lstlisting}
class Punto:
  pass
\end{lstlisting}
...
\index{instancia!objeto} \index{instancia de un objeto} \index{instanciación}\inputencoding{latin9}
\begin{lstlisting}
limpio = Punto()
\end{lstlisting}
\inputencoding{utf8}
...
Así, las sentencias que siguen son correctas:\inputencoding{latin9}
\begin{lstlisting}
...
Usted puede estar tentado a imprimir el propio valor de \texttt{limpio}:\inputencoding{latin9}
\begin{lstlisting}
>>> print(limpio)
...
utiliza el operador \texttt{==}. Por ejemplo:\inputencoding{latin9}
\begin{lstlisting}
>>> p1 = Punto()
>>> p1.x = 3
>>> p1.y = 4
...
dos variables son alias del mismo objeto:\inputencoding{latin9}
\begin{lstlisting}
>>> p2 = p1
>>> p1 == p2
True
...
\end{lstlisting}
\inputencoding{utf8} Si ahora creamos dos objetos diferentes que contienen los mismos
...
True
\end{lstlisting}
\inputencoding{utf8} Por supuesto, si las dos variables apuntan al mismo objeto \texttt{mismoPunto}
devuelve verdadero.
...
De nuevo, definiremos una nueva clase:\inputencoding{latin9}
\begin{lstlisting}
class Rectangulo:	
  pass
\end{lstlisting}
\inputencoding{utf8}
Y la instanciaremos:\inputencoding{latin9}
\begin{lstlisting}
caja = Rectangulo()
caja.ancho = 100.0
caja.altura = 200.0
...
un objeto dentro de otro!\inputencoding{latin9}
\begin{lstlisting}
caja.esquina = Punto()
caja.esquina.x = 0.0;
caja.esquina.y = 0.0;
...
que contiene las coordenadas del centro del \texttt{Rectangulo}:\inputencoding{latin9}
\begin{lstlisting}
...
se asigna el resultado a una variable:\inputencoding{latin9}
\begin{lstlisting}
...
y \texttt{altura}:\inputencoding{latin9}
\begin{lstlisting}
...
\index{encapsulamiento} \index{generalización}\inputencoding{latin9}
\begin{lstlisting}
...
y pasárselo a la función \texttt{agrandarRect}:\inputencoding{latin9}
\begin{lstlisting}
>>> b = Rectangulo()
>>> b.ancho = 100.0
>>> b.altura = 200.0
...
que puede duplicar cualquier objeto:\inputencoding{latin9}
\begin{lstlisting}
>>> import copy
>>> p1 = Punto()
>>> p1.x = 3
...
>>> b2 = copy.deepcopy(b1)
\end{lstlisting}
\inputencoding{utf8} Ahora \texttt{b1} y \texttt{b2} son objetos totalmente independientes.

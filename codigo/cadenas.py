...
def elimina_primera_letra(letra, cadena):
  ...
  if posicion_de_letra == -1:
     ...
     return cadena[0:posicion_de_letra]+cadena[posicion_de_letra+len(letra):]
...
def elimina_letra_rec(cadena,letra,pos):
  ...
  if pos_de_letra == -1:
    ...
    # si estA, pega el segmento (desde la ultima posicion en que la encontrO,
    # hasta la posicion actual) con el resultado de seguir eliminando

...
\begin{quote}
{\em Como ejercicio, modifique el programa para corregir
este error.}
\end{quote}
...
\begin{quote}
{\em Como ejercicio, modifique la función \texttt{buscar} de forma que reciba
...
\begin{quote}
{\em Como ejercicio, encapsule este código en una  función 
llamada \texttt{contarLetras}, y  generalícela de forma que reciba
la cadena y la letra como parámetros.}
\end{quote}

\begin{quote}
{\em Otro ejercicio, reescriba esta función de forma que
en lugar de recorrer la cadena, llame a la  función  {\tt
buscar} anterior que recibe tres parámetros.}
\end{quote}
...
\begin{quote}
{\em Como ejercicio, discuta qué versión de \texttt{esMinuscula} cree
